(() => {
  ...
  $(document).ready(function() {
    ...
    setInterval(function(){
      document.getElementById('background1').src = 'images/stomachimages/background.jpg?' + (new Date()).getTime();
    }, 2000);
    setTimeout(() => {
      setInterval(function(){
        document.getElementById('background2').src = 'images/stomachimages/background.jpg?' + (new Date()).getTime();
      }, 2000);
    }, 1000);
